# Generated by Django 3.0 on 2020-06-20 18:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.CharField(default=memes.models.get_invite_link, max_length=7)),
        ...
        migrations.AddConstraint(
            model_name='comment',
            constraint=models.CheckConstraint(check=models.Q(('content', None), ('deleted', False), ('image', None), _negated=True), name='content_image_both_not_null'),
        ),
    ]
