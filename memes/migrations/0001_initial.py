# Generated by Django 3.1.4 on 2021-01-12 14:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_labels', models.JSONField(default=memes.models.core.empty_json)),
                ('reviewed', models.BooleanField(default=False)),
                ('deleted', models.PositiveSmallIntegerField(choices=[(0, 'Not deleted'), (1, 'Deleted by user'), (2, 'Deleted by meme OP'), (3, 'Removed by moderator'), (4, 'Deleted by staff'), (5, 'User deleted')], default=0)),
            ],
        ),
        migrations.CreateModel(
            name='Meme',
            fields=[
                ...
                ('nsfw', models.BooleanField(default=False)),
                ('tags', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=64), default=memes.models.core.empty_list, size=None)),
                ('tags_lower', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=64), default=memes.models.core.empty_list, size=None)),
                ('report_labels', models.JSONField(default=memes.models.core.empty_json)),
                ('reviewed', models.BooleanField(default=False)),
        ...
        migrations.AddIndex(
            model_name='memelike',
            index=models.Index(fields=['user', 'meme_uuid'], name='memes_memel_user_id_b568b7_idx'),
        ),
        migrations.AddIndex(
            model_name='memelike',
            index=models.Index(fields=['user', 'point', 'liked_on'], name='memes_memel_user_id_91fccc_idx'),
        ),
        migrations.AddConstraint(
            model_name='memelike',
        ...
        migrations.AddIndex(
            model_name='meme',
            index=models.Index(fields=['user', 'upload_date'], name='memes_meme_user_id_2f77e4_idx'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['user', 'comment_uuid'], name='memes_comme_user_id_fbf1c5_idx'),
        ),
        migrations.AddIndex(
            model_name='commentlike',
            index=models.Index(fields=['user', 'point', 'liked_on'], name='memes_comme_user_id_9dc153_idx'),
        ),
        migrations.AddConstraint(
            model_name='commentlike',
