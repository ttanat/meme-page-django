# Generated by Django 3.0 on 2020-08-03 08:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reply_to_uuid', models.CharField(blank=True, max_length=11)),
                ...
                ('deleted', models.PositiveSmallIntegerField(choices=[(0, 'Not deleted'), (1, 'Deleted by user'), (2, 'Removed by moderator'), (3, 'Deleted by staff')], default=0)),
            ],
        ),
        migrations.CreateModel(
            name='CommentLike',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medium', models.FileField(blank=True, null=True, upload_to='')),
                ('thumbnail', models.ImageField(blank=True, null=True, upload_to='')),
                ('small_thumbnail', models.ImageField(blank=True, null=True, upload_to='')),
        ...
        migrations.AddField(
            model_name='notification',
            name='target_comment',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='memes.Comment'),
        ),
        migrations.AddField(
            model_name='notification',
            name='target_meme',
        ...
        migrations.AddField(
            model_name='notification',
            name='target_page',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='memes.Page'),
        ),
        migrations.AddField(
