...
router.register("profile/followers", api_profile.ProfileFollowersViewSet, basename="User")
router.register("profile/following", api_profile.ProfileFollowingViewSet, basename="User")
